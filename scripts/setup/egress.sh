...
# (the inbound edge); see docs/server-redesign.md (Phase 2, Design decisions DD-1..DD-3).
#
# Model:
...
# only. See docs/server-redesign.md.
...
# see docs/server-redesign.md (Phase 2). To use it in a shell:  set -a; . ${EGRESS_ENV}
