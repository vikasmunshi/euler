...
# primesieve
# ============================================================================
all_targets+=(primesieve)
# shellcheck disable=SC2034 # used dynamically
declare -a primesieve_packages=("primesieve" "libprimesieve-dev")
# shellcheck disable=SC2034 # used dynamically
declare -a primesieve_commands=("primesieve")
    ...
    for target in "${all_targets[@]}"; do
        case "$target" in
            ...
            lua)
                ...
                ;;
            primesieve)
                printf "  primesieve  primesieve and libprimesieve-dev C libraries\n"
                ;;
            ruby)
