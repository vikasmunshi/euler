...
problem_args_list: ProblemArgsList = [
    ProblemArgs(kwargs={'expansions': 10}, answer=1, ),  # For first 10 expansions, 1 fraction has numerator with more digits
    ProblemArgs(kwargs={'expansions': 100}, answer=15, ),  # For first 100 expansions, 15 fractions have numerator with more digits
    ProblemArgs(kwargs={'expansions': 1000}, answer=153, ),  # For first 1000 expansions (the problem statement), 153 fractions
