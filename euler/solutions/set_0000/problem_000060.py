...
# The problem number from Project Euler (https://projecteuler.net/problem=60)
problem_number: int = 60
...
def solution_problem_60(*, set_length: int) -> int:
    """
    ...
    Examples:
        >>> solution_problem_60(set_length=3)
        107  # Sum of primes [3, 37, 67]
        >>> solution_problem_60(set_length=4)
