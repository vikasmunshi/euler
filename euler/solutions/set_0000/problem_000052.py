...
# The problem number from Project Euler (https://projecteuler.net/problem=52)
problem_number: int = 52
...
def smallest_integer_with_same_digits_in_multiples_upto(*, multiples: int) -> int:
    """
    ...
    Examples:
        >>> smallest_integer_with_same_digits_in_multiples_upto(multiples=2)
        125874  # 125874 and 251748 contain the same digits
        >>> smallest_integer_with_same_digits_in_multiples_upto(multiples=6)
