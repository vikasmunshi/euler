#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r""" Solution to Project Euler problem 98: anagramic_squares
...
Problem Statement:
  ...
  different letter have the same digital value as another letter. Using words.txt
  ...
  palindromic word is NOT considered to be an anagram of itself). What is the
  largest square number formed by any member of such a pair? NOTE: All anagrams
...
test_cases: list[TestCase] = [
    TestCase(
        answer=18769,
        is_main_case=False,
        kwargs={'file_url': 'https://projecteuler.net/resources/documents/0098_words.txt'},
...
# Register this function as a solution for problem #98
@register_solution(problem_number=98, test_cases=test_cases)
...
if __name__ == '__main__':
    ...
    raise SystemExit(evaluate_solutions(98))
