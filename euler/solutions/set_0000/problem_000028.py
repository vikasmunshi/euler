...
# The problem number from Project Euler (https://projecteuler.net/problem=28)
problem_number: int = 28
...
def diagonal_sum_number_spiral(*, size: int) -> int:
    ...
    Example:
        >>> diagonal_sum_number_spiral(size=5)
        101
        >>> diagonal_sum_number_spiral(size=1001)
        669171001
    """
