...
# The problem number from Project Euler (https://projecteuler.net/problem=11)
problem_number: int = 11
...
def greatest_product_of_adjacent_numbers(*, num_adjacent: int) -> int:
    """
