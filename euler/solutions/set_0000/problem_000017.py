...
# The problem number from Project Euler (https://projecteuler.net/problem=17)
problem_number: int = 17
...
def number_letter_count(*, max_number: int) -> int:
    ...
    Example:
        >>> number_letter_count(max_number=5)  # "one", "two", "three", "four", "five"
