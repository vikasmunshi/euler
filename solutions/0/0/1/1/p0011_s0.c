...
long long solve(int argc, char *argv[]) {
    ...
    for (int x = 0; x <= dim - num_adjacent; x++) {
        for (int y = 0; y <= dim - num_adjacent; y++) {
            long long horizontal = 1, vertical = 1, diagonal_1 = 1, diagonal_2 = 1;
            ...
            if (horizontal > best) best = horizontal;
            if (vertical   > best) best = vertical;
            if (diagonal_1 > best) best = diagonal_1;
            if (diagonal_2 > best) best = diagonal_2;
        }
    }
