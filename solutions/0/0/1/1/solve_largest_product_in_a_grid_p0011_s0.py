...
"""
Migrated from:
  file: euler_solver/solutions/solutions_0001_0100/solution_0011/p0011.py
  func: solve_largest_product_in_a_grid_p0011_s0
"""
...
def main() -> int:
    print(solve(num_adjacent=int(argv[1])))
    return 0
