...
class SolutionRegistry:
    ...
    @classmethod
    def format_kwargs(cls, kwargs: dict[str, Any]) -> str:
        return ', '.join(sorted(f'{key}={cls.format_val(key, val)}' for key, val in kwargs.items()))

    @classmethod
    def format_val[T](cls, key: str, val: T) -> T | str:
