...
from euler_solver.setup.patterns import summary_re
from euler_solver.setup.register import SolutionRegistry
from euler_solver.utils.human_readable_time import seconds_from_human_readable
...
def fix_pe_problem_file(problems_file: Path) -> None:
    content: list[str] = problems_file.read_text(encoding='utf-8').splitlines()
