...
Solution Approach:
    Combine combinatorial game theory (Nim) with properties of the Towers of Hanoi
    shortest solution. Analyze the pattern of losing positions using bitwise XOR
    nim-values and Tower of Hanoi structure. Use modular arithmetic for large n.
    Expect a solution with fast mathematical insights and O(n) or better complexity.
...
test_cases: list[dict[str, Any]] = [
    ...
    {'category': 'extra', 'input': {'n': 200000}}
]


@register_solution(euler_problem=euler_problem, max_test_case_index=None)
def solve_nim_on_towers_of_hanoi_p0806_s0(*, n: int) -> int: ...
