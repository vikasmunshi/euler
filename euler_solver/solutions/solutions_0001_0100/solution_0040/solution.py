...
test_cases: list[dict[str, Any]] = [
    {'category': 'dev', 'input': {'i': 1}},
    {'category': 'dev', 'input': {'i': 2}},
    {'category': 'dev', 'input': {'i': 3}},
    {'category': 'dev', 'input': {'i': 4}},
    {'category': 'dev', 'input': {'i': 5}},
    {'category': 'dev', 'input': {'i': 6}},
    {'category': 'main', 'input': {'i': 7}},
    {'category': 'extra', 'input': {'i': 8}},
    {'category': 'extra', 'input': {'i': 9}},
    {'category': 'extra', 'input': {'i': 10}},
    {'category': 'extra', 'input': {'i': 11}}
]
