...
test_cases: list[dict[str, Any]] = [
    {'category': 'dev', 'input': {'power_of_10': 2}},
    {'category': 'dev', 'input': {'power_of_10': 3}},
    {'category': 'dev', 'input': {'power_of_10': 4}},
    {'category': 'dev', 'input': {'power_of_10': 5}},
    {'category': 'dev', 'input': {'power_of_10': 6}},
    {'category': 'main', 'input': {'power_of_10': 7}},
    {'category': 'extra', 'input': {'power_of_10': 8}},
    {'category': 'extra', 'input': {'power_of_10': 9}}
]
