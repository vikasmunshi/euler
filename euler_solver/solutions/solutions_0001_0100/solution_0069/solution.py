...
from euler_solver.c_libs.py_wrappers.primes import primes_generator
...
test_cases: list[dict[str, Any]] = [
    {'category': 'dev', 'input': {'limit': 10}},
    {'category': 'dev', 'input': {'limit': 100}},
    {'category': 'dev', 'input': {'limit': 1000}},
    {'category': 'dev', 'input': {'limit': 10000}},
    {'category': 'dev', 'input': {'limit': 100000}},
    {'category': 'main', 'input': {'limit': 1000000}}
]
