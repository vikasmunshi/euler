...
test_cases: list[dict[str, Any]] = [
    {'category': 'preliminary', 'input': {'convergent_num': 10}},
    {'category': 'main', 'input': {'convergent_num': 100}},
    {'category': 'extended', 'input': {'convergent_num': 1000}},
    {'category': 'extended', 'input': {'convergent_num': 10000}}
]
