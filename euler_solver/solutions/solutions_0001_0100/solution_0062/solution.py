...
test_cases: list[dict[str, Any]] = [
    {'category': 'dev', 'input': {'num_permutations': 2}},
    {'category': 'dev', 'input': {'num_permutations': 3}},
    {'category': 'dev', 'input': {'num_permutations': 4}},
    {'category': 'main', 'input': {'num_permutations': 5}},
    {'category': 'extra', 'input': {'num_permutations': 6}},
    {'category': 'extra', 'input': {'num_permutations': 7}},
    {'category': 'extra', 'input': {'num_permutations': 8}},
    {'category': 'extra', 'input': {'num_permutations': 9}}
]
