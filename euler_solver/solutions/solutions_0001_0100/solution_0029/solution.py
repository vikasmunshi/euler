...
from euler_solver.c_libs.primes import prime_factorization
...
test_cases: list[dict[str, Any]] = [
    {'category': 'preliminary', 'input': {'a_min': 2, 'a_max': 5, 'b_min': 2, 'b_max': 5}},
    {'category': 'main', 'input': {'a_min': 2, 'a_max': 100, 'b_min': 2, 'b_max': 100}},
    {'category': 'extended', 'input': {'a_min': 2, 'a_max': 1000, 'b_min': 2, 'b_max': 1000}}
]
