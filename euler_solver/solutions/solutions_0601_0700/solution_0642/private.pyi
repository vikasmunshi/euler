...
from euler_solver.c_libs import get_use_py_func, use_wrapped_c_function
...
test_cases: list[dict[str, Any]] = [
    {'category': 'preliminary', 'input': {'num': 10}},
    {'category': 'preliminary', 'input': {'num': 100}},
    {'category': 'preliminary', 'input': {'num': 10_000}},
    {'category': 'preliminary', 'input': {'num': 100_000}},
    {'category': 'preliminary', 'input': {'num': 1_000_000}},
    {'category': 'preliminary', 'input': {'num': 10_000_000}},
...
def solve_sum_of_largest_prime_factors_p0642_s0(*, num: int) -> int: ...


@register_solution(euler_problem=euler_problem, max_test_case=4, allow_max_override=False)
