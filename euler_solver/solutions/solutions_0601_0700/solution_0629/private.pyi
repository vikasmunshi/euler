...
Solution Approach:
    Use combinatorial game theory with dynamic programming to explore valid pile splits.
    Characterize winning positions via Grundy or nim-values influenced by the split rules.
    Efficient memoization and modular arithmetic needed to handle sums for n=200.
    Problem involves deep recursive structure and careful state encoding for performance.
...
def solve_scatterstone_nim_p0629_s0() -> int: ...
