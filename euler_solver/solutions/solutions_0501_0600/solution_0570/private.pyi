...
Solution Approach:
    Analyze the geometric construction to derive closed forms or recurrences
    for A(n) and B(n). Use number theory to compute gcd efficiently.
    Optimize summation for large n by leveraging patterns or formulas
    rather than brute force. Key methods involve combinatorics, gcd computations,
    and efficient summation techniques for large limits.
...
test_cases: list[dict[str, Any]] = [
    {'category': 'dev', 'input': {'max_order': 10}},
    {'category': 'main', 'input': {'max_order': 10000000}},
]


@register_solution(euler_problem=euler_problem, max_test_case_index=None)
def solve_snowflakes_p0570_s0(*, max_order: int) -> int: ...
