...
Solution Approach:
    Model the problem with dynamic programming over states representing the visible faces
    of the die and employ expected values calculations for optimal stopping in Ramvok.
    Use probability and Markov decision processes to compute R(d,c) and S(d,c) values.
    Employ memoization or caching for states to handle the exponential state space.
    Complexity depends on d and c, efficient pruning and numeric methods help manage time.
...
test_cases: list[dict[str, Any]] = [
    {'category': 'dev', 'input': {'max_d': 4, 'max_c': 1}},
    {'category': 'main', 'input': {'max_d': 20, 'max_c': 20}},
]


@register_solution(euler_problem=euler_problem, max_test_case_index=None)
def solve_super_ramvok_p0470_s0(*, max_d: int, max_c: int) -> int: ...
