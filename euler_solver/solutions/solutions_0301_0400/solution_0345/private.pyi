...
Solution Approach:
    Model this as a maximum-weight matching problem in a complete bipartite
    graph (rows vs columns). Use the assignment problem / Hungarian algorithm
    (Kuhn–Munkres) on the 15x15 weight matrix to find the maximum sum.
    Time complexity: O(n^3) for an n x n matrix (here n=15). Space: O(n^2).
...
def solve_matrix_sum_p0345_s0() -> int: ...
