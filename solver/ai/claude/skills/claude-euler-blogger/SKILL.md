...
3. Read the target file if it exists — it is usually a **skeleton**: a `<!-- tags: [...] -->`
   ...
   stub, and a generated `<!-- refs (generated by update-tags) … -->` block (the reference list
...
the `<!-- refs (generated by update-tags) … -->` comment exactly (leave its contents alone;
...
comment under it, and end with an empty `<!-- refs (generated by update-tags)\n-->` comment.
...
2. **Refresh the problem list:** `solver "update-tags"` — it refills every article's generated
   refs block, reconciles the graph, and rewrites `topics/articles.json` (where your new status
...
- Do not hand-edit the `<!-- refs (generated by update-tags) -->` comment or the `<!-- tags: -->`
