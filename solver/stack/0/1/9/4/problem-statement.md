# 194 - Coloured Configurations (level 28)

Consider graphs built with the units $A$: ![](resources/0194_GraphA.png)
and $B$: ![](resources/0194_GraphB.png), where the units are glued along
the vertical edges as in the graph ![](resources/0194_Fig.png).
