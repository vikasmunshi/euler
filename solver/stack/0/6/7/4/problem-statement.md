# 674 - Solving $\mathcal{I}$-equations (level 34)
...
Find the sum of least simultaneous values of all $\mathcal{I}$-expressions pairs made of distinct expressions from file [I-expressions.txt](resources/0674_i_expressions.txt) (pairs $(e_1,e_2)$ and $(e_2,e_1)$ are considered to be identical). Give the last nine digits of the result as the answer.