...
| `solver.utils.scripts` | `git-commit` | `git:execute` | `contributor` |
| `solver.utils.scripts` | `git-hooks` | `git:execute` | `contributor` |
| `solver.utils.scripts` | `git-identity` | `git:execute` | `contributor` |
| `solver.utils.scripts` | `git-merge` | `infra:execute` | `admin` |
| `solver.utils.scripts` | `git-publish` | `infra:execute` | `admin` |
| `solver.utils.scripts` | `git-push` | `git:execute` | `contributor` |
| `solver.utils.scripts` | `git-status` | `git:read` | `reader` |
| `solver.utils.scripts` | `git-sync` | `git:read` | `reader` |
