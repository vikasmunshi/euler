...
# -*- coding: utf-8 -*-
"""Migrated from
    euler_solver/solutions/solutions_0001_0100/solution_0017/p0017.py :: solve_number_letter_counts_p0017_s0.
...
number_to_word: dict[int, str] = {0: '', 1: 'one', 2: 'two', 3: 'three', 4: 'four', 5: 'five', 6: 'six', 7: 'seven',
...
placeholder_suffixes: tuple[str, ...] = ('', 'thousand', 'million', 'billion', 'trillion', 'quadrillion', 'quintillion',
