...
# -*- coding: utf-8 -*-
"""Migrated from
    euler_solver/solutions/solutions_0001_0100/solution_0093/p0093.py :: solve_arithmetic_expressions_p0093_s0.
...
def solve() -> str:
    ...
    if show_solution():
        print(f'max_digits={max_digits!r} max_length={max_length!r} max_results={max_results!r}', file=sys.stderr)
    return max_digits
