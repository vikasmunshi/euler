...
# -*- coding: utf-8 -*-
"""Migrated from
    euler_solver/solutions/solutions_0001_0100/solution_0001/p0001.py :: solve_multiples_of_3_or_5_p0001_s4.
...
def solve(*, max_limit: int) -> int:
    return sum(generate_arithmetic_series_loop(3, max_limit=max_limit)) + sum(
        generate_arithmetic_series_loop(5, max_limit=max_limit)) - sum(
        generate_arithmetic_series_loop(15, max_limit=max_limit))
